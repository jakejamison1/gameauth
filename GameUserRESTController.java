...
// FIXME: Add proper annotation to expose an endpoint as "/gameusers"
@Path("/gameusers")
...
public class GameUserRESTController {
    ...
    // FIXME: Add proper annotation to allow the USER role based on BasicAuth Security Example 
    @RolesAllowed("USER")
    @GET
    @Path("/{id}")
    ...
    // FIXME: Add proper annotation to allow the ADMIN role based on BasicAuth Security Example 
    @RolesAllowed("ADMIN")
    @POST
